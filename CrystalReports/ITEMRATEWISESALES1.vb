...
Public Class ITEMRATEWISESALES1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SmartPos.ITEMRATEWISESALES1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedITEMRATEWISESALES1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ITEMRATEWISESALES1 = New ITEMRATEWISESALES1()
        rpt.Site = Me.Site
        Return rpt
    End Function
