...
Public Class ITEMRATEWISESALES
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "SmartPos.ITEMRATEWISESALES.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedITEMRATEWISESALES
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ITEMRATEWISESALES = New ITEMRATEWISESALES()
        rpt.Site = Me.Site
        Return rpt
    End Function
