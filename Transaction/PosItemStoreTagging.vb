...
Public Class PosItemStoreTagging
    Dim Vconn As New GlobalClass

    Private Sub PosItemStoreTagging_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call Resize_Form()
        ...
        If gdataset.Tables("STORETAG").Rows.Count > 0 Then
            ssgrid1.MaxRows = gdataset.Tables("STORETAG").Rows.Count + 10
