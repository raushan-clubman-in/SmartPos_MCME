...
Imports System.IO
Public Class FRM_TKGA_BILLCLOSE
    ...
    Private Sub Resize_Form()
        ...
        End With
    End Sub
    Private Sub FRM_TKGA_BILLCLOSE_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Call Resize_Form()
    ...
    Private Sub CMD_LOCK_Click(sender As Object, e As EventArgs) Handles CMD_LOCK.Click
        Try
            ssql = "Update Bill_hdr set accountflag ='Y' where billdate Between '" & Format(dtpfromdate.Value, "dd/MMM/yyyy") & "' and '" & Format(dtptodate.Value, "dd/MMM/yyyy") & "'"
        ...
        If Len(chstr) > 0 Then
            ...
            For x = 0 To Right.Length - 1
                If Right(x) = "A" Then
                    ...
                    Exit Sub
                End If
                If UCase(Mid(Me.CMD_LOCK.Text, 1, 1)) = "U" Then
                    If Right(x) = "S" Then
                        Me.CMD_LOCK.Enabled = True
                    End If
                End If
